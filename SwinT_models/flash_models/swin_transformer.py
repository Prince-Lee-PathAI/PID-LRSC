...
import einops
from Models.SwinT_models.flash_models import flash_swin_attn_func, window_partition, window_reverse, mha_core
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, is_flash=True, qkv_bias=True, qk_scale=None, proj_drop=0.0):
    ...
    def forward(self, x, mask=None):
        ...
        if self.is_flash:
            attn = flash_swin_attn_func(q, k, v, relative_position_bias, self.scale)
        else:
